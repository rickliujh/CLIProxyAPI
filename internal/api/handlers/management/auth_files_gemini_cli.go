...
// This file implements the Gemini CLI (Cloud Code Assist) OAuth login flow and the
// project onboarding calls it depends on.
package management
...
func (h *Handler) RequestGeminiCLIToken(c *gin.Context) {
	...
	go func() {
		...
		token, err := conf.Exchange(ctx, authCode, oauth2.SetAuthURLParam("code_verifier", pkceCodes.CodeVerifier))
		if err != nil {
