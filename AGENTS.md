...
- `internal/runtime/executor/` — Per-provider runtime executors (incl. Codex WebSocket)
  - Gemini CLI reuses the Antigravity pipeline with its own identity and Code Assist wire rules; read `docs/gemini-cli.md` before changing it or the Antigravity translators
